    ...
    return (
        <div>
                ...
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                        <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                                <Link to="/"><a className="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500" aria-current="page">Login</a></Link>
                            </li>
                            <li>
                                <Link to="/SignUp"><a className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Sign Up</a></Link>
                            </li>
                            <li>
            ...
            <div className="max-w-sm mx-auto h-screen flex flex-col justify-center">
                <a className="self-center text-2xl font-bold whitespace-nonwrap">Login</a>
                <form>
                    <div className="mb-5">
                    ...
                    <div className="mb-5">
                        ...
                        <a href="#" className="text-sm font-thin text-gray-600 hover:underline mt-2 inline-block hover:text-blue-700">Forget Password</a>
                    </div>
                    <button type="submit" onClick={login} className="text-white bg-blue-700 hover:bg-blue800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                </form>
            </div>
